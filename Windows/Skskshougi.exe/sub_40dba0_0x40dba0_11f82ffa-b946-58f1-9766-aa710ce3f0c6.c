...
void* __thiscallsub_40dba0(void* arg1, void* arg2)
{
    ...
    *result = &std::_Func_impl<struct std::_Callable_obj<class <lambda_de3170ebcbad532bd8a5fb3ce7f541cf>,0>,class std::allocator<class std::_Func_class<void,enum cocos2d::EventKeyboard::KeyCode,class cocos2d::Event*> >,void,enum cocos2d::EventKeyboard::KeyCode,class cocos2d::Event*>::`vftable'{for `std::_Func_base<void,enum cocos2d::EventKeyboard::KeyCode,class cocos2d::Event*>'}
    *(result + 4) = *(arg1 + 4)
    return result
}
