...
// 函数名称: sub_418090
// 虚拟地址: 0x418090
// WARP GUID: e1b35191-952b-5326-9df3-25763870df25
...
int32_t __fastcallsub_418090(int32_t* arg1)
{
    ...
    int32_t var_60 = 0x160
    int32_t var_64 = 0x4209a0
    int32_t var_20 = 0xf
    int32_t var_24 = 0
    char var_34 = 0
    ...
    struct std::_Func_base<void, int32_t>::std::_Func_impl<struct std::_Callable_obj<class <lambda_ef569576eebc7427da054d925482baf1>,0>,class std::allocator<class std::_Func_class<void,int32_t> >,void,int32_t>::VTable
        * const var_74 = &std::_Func_impl<struct std::_Callable_obj<class <lambda_ef569576eebc7427da054d925482baf1>,0>,class std::allocator<class std::_Func_class<void,int32_t> >,void,int32_t>::`vftable'{for `std::_Func_base<void, int32_t>'}
    int32_t* var_70 = arg1
    struct std::_Func_base<void, int32_t>::std::_Func_impl<struct std::_Callable_obj<class <lambda_ef569576eebc7427da054d925482baf1>,0>,class std::allocator<class std::_Func_class<void,int32_t> >,void,int32_t>::VTable
