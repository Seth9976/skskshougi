...
void* __thiscallsub_40f210(void* arg1, void* arg2)
{
    ...
    *result = &std::_Func_impl<struct std::_Callable_obj<class <lambda_bc890b2a8328524ddf1cfa5d4c0a6919>,0>,class std::allocator<class std::_Func_class<void,enum cocos2d::EventKeyboard::KeyCode,class cocos2d::Event*> >,void,enum cocos2d::EventKeyboard::KeyCode,class cocos2d::Event*>::`vftable'{for `std::_Func_base<void,enum cocos2d::EventKeyboard::KeyCode,class cocos2d::Event*>'}
    *(result + 4) = *(arg1 + 4)
    return result
}
