...
public interface zzol extends IInterface {
    public static abstract class zza extends Binder implements zzol {
        static class com.google.android.gms.internal.zzol.zza.zza implements zzol {
            private IBinder zznF;

            com.google.android.gms.internal.zzol.zza.zza(IBinder iBinder0) {
                this.zznF = iBinder0;
            }
            ...
            public void zzaL(Status status0) throws RemoteException {
                ...
                try {
                    parcel0.writeInterfaceToken("com.google.android.gms.nearby.bootstrap.internal.INearbyBootstrapCallback");
                    if(status0 == null) {
                        parcel0.writeInt(0);
                    }
                    else {
        ...
        public static zzol zzcX(IBinder iBinder0) {
            if(iBinder0 == null) {
                return null;
            }
            IInterface iInterface0 = iBinder0.queryLocalInterface("com.google.android.gms.nearby.bootstrap.internal.INearbyBootstrapCallback");
            return iInterface0 != null && iInterface0 instanceof zzol ? ((zzol)iInterface0) : new com.google.android.gms.internal.zzol.zza.zza(iBinder0);
        }
    }
