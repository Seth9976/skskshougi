...
public interface TurnBasedMatch extends Parcelable, Freezable, Participatable {
    ...
    public static final int[] MATCH_TURN_STATUS_ALL = null;
    ...
    static {
        TurnBasedMatch.MATCH_TURN_STATUS_ALL = new int[]{0, 1, 2, 3};
    }
    ...
    Participant getParticipant(String arg1);

    String getParticipantId(String arg1);

    ArrayList getParticipantIds();

    int getParticipantStatus(String arg1);
