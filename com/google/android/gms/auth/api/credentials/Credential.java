...
public class Credential implements SafeParcelable {
    ...
    static {
        Credential.CREATOR = new zza();
    }

    Credential(int version, String internalCredentialId, String internalServerContext, String id, String name, Uri profilePictureUri, List list0, String password, String accountType) {
        this.zzCY = version;
        ...
        this.mName = name;
        this.zzOU = profilePictureUri;
        this.zzOV = list0 == null ? Collections.emptyList() : Collections.unmodifiableList(list0);
        this.zzOW = password;
        this.zzOX = accountType;
    }
