...
public class PlacesStatusCodes extends CommonStatusCodes {
    ...
    public static Status zzgU(int v) {
        return PlacesStatusCodes.zzi(v, PlacesStatusCodes.getStatusCodeString(v));
    }

    public static Status zzi(int v, String s) {
        zzu.zzu(s);
        return new Status(v, s);
    }
}
