...
public class OpenFileActivityBuilder {
    ...
    public IntentSender build(GoogleApiClient apiClient) {
        ...
        FilterHolder filterHolder0 = this.zzadx == null ? null : new FilterHolder(this.zzadx);
        try {
            return ((zzs)apiClient.zza(Drive.zzNX)).zzpB().zza(new OpenFileIntentSenderRequest(this.zzadv, this.zzadw, this.zzady, filterHolder0));
        }
    ...
    public OpenFileActivityBuilder setSelectionFilter(Filter filter) {
        ...
        zzu.zzb(z, "FullTextSearchFilter cannot be used as a selection filter");
        this.zzadx = filter;
        return this;
    }
}
