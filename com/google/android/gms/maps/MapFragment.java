...
public class MapFragment extends Fragment {
    static class zza implements MapLifecycleDelegate {
        ...
        public void getMapAsync(OnMapReadyCallback callback) {
            try {
                com.google.android.gms.maps.MapFragment.zza.1 mapFragment$zza$10 = new com.google.android.gms.maps.internal.zzm.zza() {
                ...
                this.zzaBW.getMapAsync(mapFragment$zza$10);
            }
            ...
            if(this.mActivity == null || this.zzaBZ == null || this.zzqj() != null) {
                ...
                try {
                    ...
                    if(iMapFragmentDelegate0 != null) {
                        this.zzaBZ.zza(new zza(this.zzajt, iMapFragmentDelegate0));
    ...
    public static MapFragment newInstance(GoogleMapOptions options) {
        MapFragment mapFragment0 = new MapFragment();
        Bundle bundle0 = new Bundle();
        bundle0.putParcelable("MapOptions", options);
        mapFragment0.setArguments(bundle0);
        return mapFragment0;
    }
    ...
    @Override  // android.app.Fragment
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view0 = this.zzaBU.onCreateView(inflater, container, savedInstanceState);
    ...
    public void onInflate(Activity activity, AttributeSet attrs, Bundle savedInstanceState) {
        ...
        this.zzaBU.onInflate(activity, bundle1, savedInstanceState);
    }
