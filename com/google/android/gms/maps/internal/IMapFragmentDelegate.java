...
public interface IMapFragmentDelegate extends IInterface {
    public static abstract class zza extends Binder implements IMapFragmentDelegate {
        static class com.google.android.gms.maps.internal.IMapFragmentDelegate.zza.zza implements IMapFragmentDelegate {
            private IBinder zznF;

            com.google.android.gms.maps.internal.IMapFragmentDelegate.zza.zza(IBinder iBinder0) {
                this.zznF = iBinder0;
            }
            ...
            public IGoogleMapDelegate getMap() throws RemoteException {
                ...
                try {
                    parcel0.writeInterfaceToken("com.google.android.gms.maps.internal.IMapFragmentDelegate");
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch(code) {
                case 1: {
                    ...
                    reply.writeStrongBinder((iGoogleMapDelegate0 == null ? null : iGoogleMapDelegate0.asBinder()));
                    return true;
                }
                case 2: {
                    data.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                    this.onInflate(com.google.android.gms.dynamic.zzd.zza.zzbg(data.readStrongBinder()), (data.readInt() == 0 ? null : GoogleMapOptions.CREATOR.zzeI(data)), (data.readInt() == 0 ? null : ((Bundle)Bundle.CREATOR.createFromParcel(data))));
                    reply.writeNoException();
                    return true;
                }
                case 3: {
        ...
        public static IMapFragmentDelegate zzcl(IBinder iBinder0) {
            if(iBinder0 == null) {
                return null;
            }
            IInterface iInterface0 = iBinder0.queryLocalInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
            return iInterface0 != null && iInterface0 instanceof IMapFragmentDelegate ? ((IMapFragmentDelegate)iInterface0) : new com.google.android.gms.maps.internal.IMapFragmentDelegate.zza.zza(iBinder0);
        }
    }
    ...
    void onInflate(zzd arg1, GoogleMapOptions arg2, Bundle arg3) throws RemoteException;
