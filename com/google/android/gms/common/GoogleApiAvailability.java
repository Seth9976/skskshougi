...
public class GoogleApiAvailability {
    ...
    private static final GoogleApiAvailability zzVI;

    static {
        GoogleApiAvailability.GOOGLE_PLAY_SERVICES_VERSION_CODE = GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_VERSION_CODE;
        GoogleApiAvailability.zzVI = new GoogleApiAvailability();
    }
    ...
    public static GoogleApiAvailability getInstance() {
        return GoogleApiAvailability.zzVI;
    }
    ...
    public int isGooglePlayServicesAvailable(Context context) {
        int v = GooglePlayServicesUtil.isGooglePlayServicesAvailable(context);
        return GooglePlayServicesUtil.zze(context, v) ? 18 : v;
    }
    ...
    public void zzZ(Context context0) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
