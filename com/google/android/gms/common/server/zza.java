...
public class zza implements Parcelable.Creator {
    ...
    static void zza(FavaDiagnosticsEntity favaDiagnosticsEntity0, Parcel parcel0, int v) {
        int v1 = zzb.zzac(parcel0);
        zzb.zzc(parcel0, 1, favaDiagnosticsEntity0.zzCY);
        zzb.zza(parcel0, 2, favaDiagnosticsEntity0.zzaby, false);
        zzb.zzc(parcel0, 3, favaDiagnosticsEntity0.zzabz);
        zzb.zzH(parcel0, v1);
    }

    public FavaDiagnosticsEntity zzad(Parcel parcel0) {
        int v = 0;
        ...
        return new FavaDiagnosticsEntity(v2, s, v);
    }

    public FavaDiagnosticsEntity[] zzbD(int v) {
        return new FavaDiagnosticsEntity[v];
    }
}
