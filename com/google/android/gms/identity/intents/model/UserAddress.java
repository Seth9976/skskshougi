...
public final class UserAddress implements SafeParcelable {
    ...
    public static UserAddress fromIntent(Intent data) {
        return data != null && data.hasExtra("com.google.android.gms.identity.intents.EXTRA_ADDRESS") ? ((UserAddress)data.getParcelableExtra("com.google.android.gms.identity.intents.EXTRA_ADDRESS")) : null;
    }
